...
WX[[3]] = matrix(c(1/3, 0, 0, 
                   .05/3, .9/3, .05/3,
                   .1/3, .1/3, .8/3), nrow = 3, ncol = 3, byrow = TRUE)
WX[[4]] = matrix(c(.9/3, .05/3, .05/3, 
                   .1/3, .8/3, .1/3,
...
save(generated_distributions, file = "distributions_WX.RData")
save(generated_datasets,      file = "datasets_WX.RData")

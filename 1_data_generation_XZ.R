...
XZ[[2]] = matrix(c(.012, .97/3, 
                   .010, .97/3,
                   .008, .97/3), nrow = 3, ncol = 2, byrow = TRUE)
XZ[[3]] = matrix(c(.015, .97/3, 
                   .010, .97/3,
                   .005, .97/3), nrow = 3, ncol = 2, byrow = TRUE)
XZ[[4]] = matrix(c(.018, .97/3, 
                   .010, .97/3,
...
save(generated_distributions, file = "distributions_XZ.RData")
save(generated_datasets,      file = "datasets_XZ.RData")
